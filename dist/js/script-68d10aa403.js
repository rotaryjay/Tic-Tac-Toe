...
document.getElementById('backgroundThumbnail1').addEventListener('click', function() {
    document.querySelector(".tictactoe").style.background="url('img/background.jpg')"; 
});
document.getElementById('backgroundThumbnail2').addEventListener('click', function() {
    document.querySelector(".tictactoe").style.background="url('img/kowshik-roy-sagor-JhDHKezS6O8-unsplash.jpg')"; 
});
document.getElementById('backgroundThumbnail3').addEventListener('click', function() {
    document.querySelector(".tictactoe").style.background="url('img/ryunosuke-kikuno-nX0NgrGEwEc-unsplash.jpg')"; 
});
