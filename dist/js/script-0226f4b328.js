...
document.getElementById('backgroundThumbnail1').addEventListener('click', function() {
    const background1 = document.querySelector('.tictactoe');
    background1.computedStyleMap.background = 'url(img/background.jpg)';
});
document.getElementById('backgroundThumbnail2').addEventListener('click', function() {
    const background2 = document.querySelector('.tictactoe');
    background2.computedStyleMap.background = 'url(img/kowshik-roy-sagor-JhDHKezS6O8-unsplash.jpg)';
});
document.getElementById('backgroundThumbnail3').addEventListener('click', function() {
    const background3 = document.querySelector('.tictactoe');
    background3.computedStyleMap.background = 'url(img/ryunosuke-kikuno-nX0NgrGEwEc-unsplash.jpg)';
});
